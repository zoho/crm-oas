...
**Operation:** `updateEmailDrafts` — Update an Email Draft
...
**Request Body** (required) — application/json
  ...
  - `__email_drafts` (array of object) [maxItems=1] **REQ** — List containing the single draft to update.
...
- **200**: Returns the update result when the email draft is updated successfully. [application/json]
    > Response object containing the result of updating email drafts.
    - `__email_drafts` (array of object) [maxItems=1] **REQ** — List of updated email draft results.
...
**Resolution:** Review the error details, correct any invalid fields, and retry the request.
 [application/json]
    ...
    - `code` (string) [maxLen=100, enum=['INVALID_DATA', 'INVALID_MODULE']] — Machine-readable error code for generic errors.
...
- **INVALID_MODULE** - The specified module is invalid.
    ...
    - `__email_drafts` (array of object) [maxItems=1] — Per-draft validation error array (present for batch validation errors).
