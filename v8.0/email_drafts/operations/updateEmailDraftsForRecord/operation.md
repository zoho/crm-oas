...
**Operation:** `updateEmailDraftsForRecord` — Update Email Drafts for a Record
...
**Request Body** (required) — application/json
  ...
  - `__email_drafts` (array of object) [maxItems=100] **REQ** — List of email drafts to update.
    - `id` (string) **REQ** [maxLen=256] — Encrypted draft identifier. Required to identify which draft to update. Use the [Get Email Drafts](email_drafts.yaml#$.paths./{module}/{record}/__email_drafts.get) resource to retrieve draft IDs.
    ...
    - `to` (array of object) [maxItems=100] — Primary recipients. Replaces the existing list.
    ...
    - `cc` (array of object) [maxItems=100] — CC recipients. Replaces the existing list.
    ...
    - `bcc` (array of object) [maxItems=100] — BCC recipients. Replaces the existing list.
    ...
    - `inventory_details` (object) — Inventory email details; null to remove.
    ...
    - `rich_text` (boolean) **REQ** — true for HTML editor; false for plain text.
    ...
    - `linked_record` (object) — CRM record to link this draft to; null to clear.
    ...
    - `attachments` (array of object) [maxItems=50] — Attachments list; replaces existing.
      ...
      - `_delete` (boolean) — true to remove this attachment.

**Responses:**

- **200**: Returns the update results when all email drafts in the request are updated successfully. [application/json]
    > Response object containing the result of updating email drafts.
    - `__email_drafts` (array of object) [maxItems=100] **REQ** — List of updated email draft results.
      ...
      - `details` (object) **REQ** — Details of the updated draft.
        - `id` (string) **REQ** [maxLen=256] — Encrypted identifier of the updated draft.
...
**Scopes:** ZohoCRM.modules.leads.UPDATE, ZohoCRM.modules.accounts.UPDATE, ZohoCRM.modules.contacts.UPDATE, ZohoCRM.modules.deals.UPDATE, ZohoCRM.modules.quotes.UPDATE, ZohoCRM.modules.salesorders.UPDATE, ZohoCRM.modules.purchaseorders.UPDATE, ZohoCRM.modules.invoices.UPDATE, ZohoCRM.modules.vendors.UPDATE, ZohoCRM.modules.custom.UPDATE, ZohoCRM.modules.cases.UPDATE
