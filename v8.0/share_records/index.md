...
- [Share Records](mds/getShareRecords.md)
  ...
  - [Examples](mds/examples/getShareRecords.md)
- [Share a record](mds/createShareRecords.md)
  ...
  - [Examples](mds/examples/createShareRecords.md)
- [Update share permissions](mds/updateShareRecords.md)
  ...
  - [Examples](mds/examples/updateShareRecords.md)
- [Revoke sharing on a record](mds/deleteShareRecords.md)
  ...
  - [Examples](mds/examples/deleteShareRecords.md)
