# Examples: getWorkflowTasks

**GET /settings/automation/tasks**

## Response examples

### Status `200` — `application/json` — TasksListSuccess
...
Error response when module param value is invalid
...
Error response when feature_type param is invalid
...
Error response when sort_by param is invalid
...
Error response when sort_order param is invalid
...
Error response when edition lacks workflow task permissions
