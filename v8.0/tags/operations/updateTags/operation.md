...
> The request body must contain a **tags** array with one tag object. Include the tag **ID** in the object to identify which tag to update.
...
- **200**: Returns a success response when the tag update completes. The response includes the updated tag details. — Schema: `PuttagsResponse200` [application/json]
...
**Resolution:** Check the error code and verify the field values and tag ID are correct. [application/json]
