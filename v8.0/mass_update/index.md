...
- [Mass update records](operations/massUpdateRecords/operation.md)
  ...
  - [Examples](operations/massUpdateRecords/examples/)
- [Get mass update job status](operations/getMassUpdateStatus/operation.md)
  ...
  - [Examples](operations/getMassUpdateStatus/examples/)
