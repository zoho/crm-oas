...
- [Link Emails to Deals](mds/linkEmailsToDeals.md)
  ...
  - [Examples](mds/examples/linkEmailsToDeals.md)
- [Unlink Emails from Deals](mds/unlinkEmailsFromDeal.md)
  ...
  - [Examples](mds/examples/unlinkEmailsFromDeal.md)
- [Link Deal Email](mds/linkEmailToRecord.md)
  - Links an email to a specified record in CRM.
  - [Examples](mds/examples/linkEmailToRecord.md)
- [Unlink Deal Email](mds/unlinkEmailFromRecord.md)
  - Unlinks an email from a specified record in CRM.
  - [Examples](mds/examples/unlinkEmailFromRecord.md)
