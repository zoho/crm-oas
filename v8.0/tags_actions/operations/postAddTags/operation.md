...
**Operation:** `postAddTags` — Add Tags to Records
...
> Request body containing the tags to associate and the record IDs.
...
- **200**: OK - Tags associated successfully. — Schema: `PostaddtagsResponse200` [application/json]
