...
- [OpenAPI specification](mail_merge.yaml)
- [Send mail merge email](operations/postSendMailMerge/operation.md)
  ...
  - [Examples](operations/postSendMailMerge/examples/)
- [Send mail merge document for signing](operations/postSignMailMerge/operation.md)
  ...
  - [Examples](operations/postSignMailMerge/examples/)
- [Download mail merge document](operations/postDownloadMailMerge/operation.md)
  ...
  - [Examples](operations/postDownloadMailMerge/examples/)
