...
**Operation:** `getTerritoriesOfUser` — Get territories of a user
...
- **200**: Returns a **territories** array with the territories assigned to the user and pagination **info**. — Schema: `TerritoryGetResponse` [application/json]
...
- **204**: No territories are assigned to the specified user.
