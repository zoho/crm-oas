...
- [Rich text field content for multiple records](operations/fetchFullDataForMultipleRecords/operation.md)
  ...
  - [Examples](operations/fetchFullDataForMultipleRecords/examples/)
- [Rich text field content for a specific record](operations/fetchFullDataForSingleRecord/operation.md)
  ...
  - [Examples](operations/fetchFullDataForSingleRecord/examples/)
