...
- [Activate Layout](operations/activateLayout/operation.md)
  ...
  - [Examples](operations/activateLayout/examples/)
- [Deactivate Layout](operations/layoutDeactivate/operation.md)
  ...
  - [Examples](operations/layoutDeactivate/examples/)
