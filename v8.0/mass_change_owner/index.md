...
- [Submit mass change owner job](mds/massChangeOwner.md)
  ...
  - [Examples](mds/examples/massChangeOwner.md)
- [Get mass change owner job status](mds/getMassChangeOwnerStatus.md)
  ...
  - [Examples](mds/examples/getMassChangeOwnerStatus.md)
