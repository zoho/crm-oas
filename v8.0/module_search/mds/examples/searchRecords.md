...
### Status `200` — `application/json` — LeadSearchResult

Sample lead search result

```json
{
  "data": [
    {
      "id": "5843104000000624035",
      "Owner": {
        "name": "John Smith",
        "id": "5843104000000411001",
        "email": "john.smith@example.com"
      },
      "Company": "Zylker",
      "Email": "lead@zylker.com",
