# Examples: postUnenrolFromCadences
...
Sample unenroll records request
...
Successful un-enrollment result
...
Multi-status response with partial un-enrollment success
...
### Status `400` — `application/json` — InvalidDataResponseArray
