...
- [Create a bulk read job](operations/createBulkReadJob/operation.md)
  ...
  - [Examples](operations/createBulkReadJob/examples/)
- [Get bulk read job details](operations/getBulkReadJobDetails/operation.md)
  ...
  - [Examples](operations/getBulkReadJobDetails/examples/)
- [Download bulk read result](operations/downloadBulkReadResult/operation.md)
  ...
  - [Examples](operations/downloadBulkReadResult/examples/)
