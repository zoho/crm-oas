...
**Operation:** `updateWorkflowRule` — Update workflow rules by ID in the request body
...
- **200**: Workflow Rule updated successfully — Schema: `WorkflowSuccessSchema` [application/json]
