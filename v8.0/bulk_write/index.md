...
- [Create a bulk write job](operations/createBulkWriteJob/operation.md)
  ...
  - [Examples](operations/createBulkWriteJob/examples/)
- [Get bulk write job details](operations/getBulkWriteJobDetails/operation.md)
  ...
  - [Examples](operations/getBulkWriteJobDetails/examples/)
