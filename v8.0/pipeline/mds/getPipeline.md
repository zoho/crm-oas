...
**Operation:** `getPipeline` — Specific Pipeline
...
- **200**: Successfully retrieved the requested pipeline. — Schema: `SinglePipelineGetResponse` [application/json]
    > Root response object containing an array of pipeline configurations from Zoho CRM.
    schema: `SinglePipelineGetResponse`
    - `pipeline` (array of object) [minItems=1, maxItems=1] **REQ** — Array of pipeline configuration items.
...
- **204**: No pipeline was found for the given pipeline ID and layout combination.
