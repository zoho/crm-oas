...
**Operation:** `replacePipelineById` — Pipeline
...
- **200**: The specified pipeline was updated successfully. — Schema: `PipelineSuccessResponse` [application/json]
...
- **400**: The request is invalid due to an invalid pipeline ID, invalid layout_id, invalid stage data, missing required fields, or other pipeline validation errors. [application/json]
    oneOf:
