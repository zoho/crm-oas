...
**Operation:** `updatePipelines` — Pipeline
...
- **200**: The pipeline was updated or deleted successfully. — Schema: `PipelineSuccessResponse` [application/json]
...
- **400**: The request is invalid due to an invalid layout_id, invalid stage mapping, duplicate pipeline label, missing mandatory data, or other pipeline update/delete validation errors. [application/json]
    oneOf:
