...
- [Get Appointment Records](operations/getAppointmentsS/operation.md)
  ...
  - [Examples](operations/getAppointmentsS/examples/)
- [Update appointment records ](operations/updateAppointmentsS/operation.md)
  ...
  - [Examples](operations/updateAppointmentsS/examples/)
- [Create Appointment records](operations/createAppointmentsS/operation.md)
  - To create one or more appointment records in your Zoho CRM organization.
  - [Examples](operations/createAppointmentsS/examples/)
- [Delete one or more appointment records ](operations/deleteAppointmentsS/operation.md)
  ...
  - [Examples](operations/deleteAppointmentsS/examples/)
- [Get an Appointment Record by ID ](operations/getAppointmentById/operation.md)
  - To retrieve the details of a single appointment record from your Zoho CRM organization.
  - [Examples](operations/getAppointmentById/examples/)
- [Update an Appointment Record by ID](operations/updateAppointmentById/operation.md)
  - To update a single appointment record by its ID in your Zoho CRM organization.
  - [Examples](operations/updateAppointmentById/examples/)
- [Delete an Appointment by ID ](operations/deleteAppointmentById/operation.md)
  ...
  - [Examples](operations/deleteAppointmentById/examples/)
