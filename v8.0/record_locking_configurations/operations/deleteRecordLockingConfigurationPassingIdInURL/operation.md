...
**Operation:** `deleteRecordLockingConfigurationPassingIdInURL` — Delete specific record locking configuration
...
- **200**: Successfully deleted the specified record locking configuration. [application/json]
    > Response object for a successful deletion.
    - `record_locking_configurations` (array of object) [maxItems=1] **REQ** — Array containing the deletion response.
