...
**Operation:** `getRecordLockingConfigurationPassingIdInURL` — Get specific record locking configuration
...
- **200**: Successfully retrieved the specified record locking configuration details. [application/json]
...
- **204**: No record locking configuration exists for the provided ID in the specified module.
