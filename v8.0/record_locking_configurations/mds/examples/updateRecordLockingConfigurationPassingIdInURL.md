# Examples: updateRecordLockingConfigurationPassingIdInURL
...
Request body for updating a specific record locking configuration
...
Successful response for updating a specific configuration
