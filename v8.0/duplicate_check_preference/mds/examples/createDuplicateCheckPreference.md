# Examples: createDuplicateCheckPreference
...
### Status `400` — `application/json` — AlreadyConfigured
...
### Status `403` — `application/json` — FeatureNotEnabledForMappedModule

Mapped module is not supported
...
```json
{
  "duplicate_check_preference": {
    ...
    "details": {
      "api_name": "mapped_module",
      "json_path": "$.duplicate_check_preference[0].type_configurations.mapped_module.id"
    },
    "message": "feature not support in this module",
    "status": "error"
  }
}
```
